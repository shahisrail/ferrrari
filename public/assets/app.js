...
function getPercent(el, offset = false) {
  ...
  const elTop = rect.top + window.scrollY - o;
  let percent = 0;

  if (windowTop > elTop) {
    const scrolled = Math.abs(elTop - windowTop);
    percent = scrolled * 100 / rect.height;
  }
...
function isInView(el, limit = 25) {
  ...
  //     rect.top >= 0 &&
  //     rect.left >= 0 &&
  //     rect.bottom <= (window.innerHeight + el.offsetHeight * 0.7 || document.documentElement.clientHeight) &&
...
/***/ "./node_modules/slidetoggle/dist/esm/index.js":
/*!****************************************************!*\
  !*** ./node_modules/slidetoggle/dist/esm/index.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "slideToggle": () => (/* reexport safe */ _lib_slideToggle__WEBPACK_IMPORTED_MODULE_0__.slideToggle)
/* harmony export */ });
/* harmony import */ var _lib_slideToggle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/slideToggle */ "./node_modules/slidetoggle/dist/esm/lib/slideToggle.js");

//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/slidetoggle/dist/esm/lib/builder.js":
/*!**********************************************************!*\
  !*** ./node_modules/slidetoggle/dist/esm/lib/builder.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "builder": () => (/* binding */ builder)
/* harmony export */ });
/* harmony import */ var _slideDown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slideDown */ "./node_modules/slidetoggle/dist/esm/lib/slideDown.js");
/* harmony import */ var _slideUp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slideUp */ "./node_modules/slidetoggle/dist/esm/lib/slideUp.js");


var Builder = (function () {
    function Builder() {
        this.prototypeMap = {};
        this.prototypeMap.up = _slideUp__WEBPACK_IMPORTED_MODULE_1__.slideUp;
        this.prototypeMap.down = _slideDown__WEBPACK_IMPORTED_MODULE_0__.slideDown;
    }
...
/***/ "./node_modules/slidetoggle/dist/esm/lib/dtos.js":
/*!*******************************************************!*\
  !*** ./node_modules/slidetoggle/dist/esm/lib/dtos.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "attrData": () => (/* binding */ attrData)
/* harmony export */ });
...
/***/ "./node_modules/slidetoggle/dist/esm/lib/elProps.js":
/*!**********************************************************!*\
  !*** ./node_modules/slidetoggle/dist/esm/lib/elProps.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ElProps": () => (/* binding */ ElProps),
/* harmony export */   "elProps": () => (/* binding */ elProps)
/* harmony export */ });
...
/***/ "./node_modules/slidetoggle/dist/esm/lib/slideDown.js":
/*!************************************************************!*\
  !*** ./node_modules/slidetoggle/dist/esm/lib/slideDown.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "slideDown": () => (/* binding */ slideDown)
/* harmony export */ });
/* harmony import */ var _dtos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dtos */ "./node_modules/slidetoggle/dist/esm/lib/dtos.js");
...
/***/ "./node_modules/slidetoggle/dist/esm/lib/slideToggle.js":
/*!**************************************************************!*\
  !*** ./node_modules/slidetoggle/dist/esm/lib/slideToggle.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "slideToggle": () => (/* binding */ slideToggle)
/* harmony export */ });
/* harmony import */ var _builder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./builder */ "./node_modules/slidetoggle/dist/esm/lib/builder.js");
/* harmony import */ var _dtos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dtos */ "./node_modules/slidetoggle/dist/esm/lib/dtos.js");
/* harmony import */ var _elProps__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./elProps */ "./node_modules/slidetoggle/dist/esm/lib/elProps.js");
...
var SlideToggle = (function () {
    ...
    SlideToggle.prototype.slideToggle = function (el, timingFn) {
        ...
        var props = _elProps__WEBPACK_IMPORTED_MODULE_2__.elProps.getElProps(currentEl);
        this.getPrototypOfStrategy(props.height).sliding(currentEl, props.height ? props : _elProps__WEBPACK_IMPORTED_MODULE_2__.elProps.getOriginalProps(currentEl), timingFn);
    };
    ...
    SlideToggle.prototype.getPrototypOfStrategy = function (height) {
        return _builder__WEBPACK_IMPORTED_MODULE_0__.builder.createPrototype(height ? 'up' : 'down');
    };
    SlideToggle.prototype.isElementSliding = function (el) {
        return el.hasAttribute(_dtos__WEBPACK_IMPORTED_MODULE_1__.attrData) && el.getAttribute(_dtos__WEBPACK_IMPORTED_MODULE_1__.attrData) === 'true';
    };
    SlideToggle.prototype.setElRequiredDataAndChangeAttr = function (el) {
        el.style.overflowY = 'hidden';
        var currentAttrState = el.getAttribute(_dtos__WEBPACK_IMPORTED_MODULE_1__.attrData) || '';
        if (currentAttrState === 'true')
            el.setAttribute(_dtos__WEBPACK_IMPORTED_MODULE_1__.attrData, 'false');
        else
            el.setAttribute(_dtos__WEBPACK_IMPORTED_MODULE_1__.attrData, 'true');
    };
    return SlideToggle;
}());
...
/***/ "./node_modules/slidetoggle/dist/esm/lib/slideUp.js":
/*!**********************************************************!*\
  !*** ./node_modules/slidetoggle/dist/esm/lib/slideUp.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var split_text_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! split-text-js */ "./node_modules/split-text-js/SplitTextJS.js");
/* harmony import */ var split_text_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(split_text_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var slidetoggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! slidetoggle */ "./node_modules/slidetoggle/dist/esm/index.js");
/* harmony import */ var vanilla_marquee__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! vanilla-marquee */ "./node_modules/vanilla-marquee/dist/vanilla-marquee.js");
...
/* harmony import */ var _Utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Utils */ "./src/js/Utils/index.js");
...
new class GucciCareers {
  constructor() {
    ...
    console.log("Gucci Careers Starter");

    if (window.location.href.indexOf("cookie-policy") === -1) {
      this.common();
    }

    imagesloaded__WEBPACK_IMPORTED_MODULE_2___default()(document.querySelector("body"), this.onLoad.bind(this));
    this.bannerSetUp();
  }

  bannerSetUp() {
    // console.log(document.querySelector('#language').value);
    const bannerActive = document.querySelector("#bannerActive").value === "1" ? true : false; // console.log(document.querySelector('#bannerActive').value);
    // if (bannerActive) {
    // const currentLangCode = document.querySelector('#language').value

    this.bannerType = document.querySelector("#bannerType").value;
    const bannerImgDesk = document.querySelector("#bannerImgDesk").value;
    const bannerImgMobile = document.querySelector("#bannerImgMobile").value;
    const myMediaQuery = window.matchMedia("(max-width: 666px)"); // const bannerLangs = JSON.parse(document.querySelector('#bannerLang').value)

    if (this.bannerType === "images") {
      if (myMediaQuery.matches) {
        document.querySelector(".banner-link").style.backgroundImage = "url(" + bannerImgMobile + ")";
      } else {
        document.querySelector(".banner-link").style.backgroundImage = "url(" + bannerImgDesk + ")";
      }
    }

    const previousLangCode = document.referrer.split("/")[3];
    let pageSwictch = document.referrer.indexOf(window.location.host) > -1 && previousLangCode !== "it";
    let countRefresh = parseInt(localStorage.getItem("counter") || 0);
    window.addEventListener("unload", function () {
      if (countRefresh > 1) {
        localStorage.removeItem("counter");
      } else {
        localStorage.setItem("counter", ++countRefresh);
      }
    }, false); // console.log(localStorage.getItem('counter'));
    // console.log(typeof localStorage.getItem('counter'));
    // sessionStorage.setItem('pageHasBeenLoaded', 'true');

    if (bannerActive) {
      if (window.location.hash !== "" && countRefresh > 1) {
        sessionStorage.removeItem("is_reloaded");
      }

      if (sessionStorage.getItem("is_reloaded")) {
        // console.log("no banner");
        document.querySelector(".banner-offset").style.display = "none";
        return;
      } else {
      ...
      if (document.referrer.indexOf(window.location.host) === -1 || window.location.hash !== "" || pageSwictch) {
        setTimeout(() => {
          this.bannerConfigUI();
        }, 4500);
      } else {
  ...
  test() {
    const element = document.querySelector("[data-transition]");
    const speed = 2500;
  ...
  onReady() {
    ...
    this.main.classList.add("in");
    this.header.classList.add("in");
    setTimeout(() => {
      this.view = document.querySelector("[data-barba-namespace]").getAttribute("data-barba-namespace");
      ...
      switch (this.view) {
        case "home":
          document.querySelector(".page-cover__transition").classList.add("in");
          this.home();
          break;
  ...
  barba() {
    ...
    function _before() {
      that.scroll.stop();
      that.isHome = false;
      that.main.classList.remove("in");
      that.menu.classList.remove("open");
      that.menuTrigger.classList.remove("open");
    }

    function _leave() {
      that.scroll.scrollTo(0, {
        duration: 0
      });
    }
  ...
  russianExcept() {
    const body = document.body; // if (window.location.href.indexOf("/ru") != -1) {
    //     body.style.fontFamily = "sans-serif"
    // }

    function scaleHeader2() {
      const minSize = 10;
      const maxSize = window.location.href.indexOf("zh-hans") != -1 ? 300 : 2000;
      const elements = [...document.querySelectorAll("[data-text-full]")];
      let x = 0;
      elements.map(el => {
        const maxWidth = el.closest("h3").offsetWidth;
        let found = false;
        ...
        for (let i = minSize; i <= maxSize; i++) {
          ...
          el.querySelector("em").style.fontSize = i + "px";
  ...
  setupHeader() {
    ...
    this.menuTrigger = this.header.querySelector(".main-header__trigger");
    this.menuTrigger.addEventListener("click", e => {
      e.preventDefault();
      const paths = ["/home-1", "/home-2", "/home-3", "/review-1", "/review-2", "/review-3"];
      if (paths.some(path => window.location.pathname.includes(path))) return;
      this.menuTrigger.classList.toggle("open");
      this.menu.classList.toggle("open");
    });
    let isopen = false;
    let isOpenMobile = false;
    this.langs = document.querySelector(".langs");
    this.langsMobile = document.querySelector(".langs-mobile");
    this.langsTrigger = document.querySelector(".langs span");
    this.langsTriggerMobile = document.querySelector(".langs-mobile span");
    this.langsTrigger.addEventListener("click", e => {
      e.preventDefault();
      isopen = !isopen;
      this.langs.classList.toggle("open");
    });
    this.langsTriggerMobile.addEventListener("click", e => {
      e.preventDefault();
      isOpenMobile = !isOpenMobile;
      this.langsMobile.classList.toggle("open");
    }); // this.menu.addEventListener('click', (e) => {
    //     if (isopen) {
    //         isopen = false
    //         this.langs.classList.remove('open')
    //     }
    // })
  }

  smoothScroll() {
    const lerp = (0,_Utils__WEBPACK_IMPORTED_MODULE_11__.isTouchDevice)() ? 0.1 : 0.2;
    this.scroll = new locomotive_scroll__WEBPACK_IMPORTED_MODULE_3__.default({
      smooth: true,
      lerp: lerp,
  ...
  fixedElements() {
    ...
    function home() {
      that.homeNav = document.querySelector("#home-nav");
      const elements = [...that.homeNav.querySelectorAll("a")];
      elements.map(el => {
        el.addEventListener("click", e => {
          e.preventDefault();
          const target = el.getAttribute("href");
          that.scroll.stop();
          that.scroll.scrollTo(document.querySelector(target), {
            duration: 500,
            // offset: -92,
            callback: () => {
              that.scroll.start();
      ...
      that.scroll.on("scroll", () => {
        switch (that.view) {
          case "home":
            const first = document.querySelector("#scene-01").getBoundingClientRect();
            const last = document.querySelector("#scene-04").getBoundingClientRect();

            if (that.scrollTop > first.top) {
              that.homeNav.classList.add("in");
            } else {
              that.homeNav.classList.remove("in");
            }

            if (that.scrollTop > last.top) {
              that.homeNav.classList.remove("in");
            }

            if (that.scrollTop - window.innerHeight > document.querySelector("#scene-01").getBoundingClientRect().top) {
              document.querySelector('#home-nav [href="#scene-01"]').classList.add("current");
              document.querySelector('#home-nav [href="#scene-02"]').classList.remove("current");
              document.querySelector('#home-nav [href="#scene-03"]').classList.remove("current");
            }

            if (that.scrollTop - window.innerHeight > document.querySelector("#scene-02").getBoundingClientRect().top) {
              document.querySelector('#home-nav [href="#scene-01"]').classList.remove("current");
              document.querySelector('#home-nav [href="#scene-02"]').classList.add("current");
              document.querySelector('#home-nav [href="#scene-03"]').classList.remove("current");
            }

            if (that.scrollTop - window.innerHeight > document.querySelector("#scene-03").getBoundingClientRect().top) {
              document.querySelector('#home-nav [href="#scene-01"]').classList.remove("current");
              document.querySelector('#home-nav [href="#scene-02"]').classList.remove("current");
              document.querySelector('#home-nav [href="#scene-03"]').classList.add("current");
            }
    ...
    function community() {
      const panel = document.querySelector("#jobs-nav");
      const footer = document.querySelector("#footer");
      panel.querySelector(".jobs-nav__trigger").addEventListener("click", e => {
        e.preventDefault();
      ...
      that.scroll.on("scroll", () => {
        switch (that.view) {
          case "community":
            if (that.scrollTop > window.innerHeight) {
              panel.classList.add("in");
            } else {
              panel.classList.remove("in");
            }

            if (that.scrollTop > footer.getBoundingClientRect().top) {
  ...
  transitions(dir) {
    this.pageTransition = document.querySelector('[data-transition="stripe"]');

    if (dir === "out") {
      this.pageTransition.classList.add("out");
    } else {
      this.pageTransition.classList.remove("out");
    }
  }

  bannerConfigUI() {
    const closeBtn = document.querySelector(".close-container");
    const bannerSelector = this.bannerType === "code" ? ".banner" : ".banner-container";
    const banner = document.querySelector(bannerSelector);
    const bannerOffset = document.querySelector(".banner-offset");
    ...
    if (this.bannerType === "code") {
      const cta = document.querySelector(".grade-cta");
    ...
    setTimeout(() => {
      ...
      bannerOffset.style.opacity = 0.7;
    }, 3000);
  }
  ...
  animateElements() {
    ...
    function check() {
      ...
      elements.map(el => {
        const parent = el.closest("[data-scroll-section]");

        if ((0,_Utils__WEBPACK_IMPORTED_MODULE_11__.isInView)(el) && !el.classList.contains("animated") && window.getComputedStyle(parent).display !== "none" && window.getComputedStyle(el).display !== "none") {
          el.classList.add("animated");
          setTimeout(() => {
            el.classList.add("in");
          }, el.getAttribute("data-in"));
        }
      });
    }

    this.scroll.on("scroll", check);
  }

  textFull() {
    function scaleHeader() {
      var scalable = document.querySelectorAll("[data-text-full]");
      var margin = 0;
    ...
    const scaleFn = (0,_Utils__WEBPACK_IMPORTED_MODULE_11__.debounce)(function () {
      scaleHeader2();
    }, 250);
    scaleHeader2();
  ...
  textHighlight() {
    const elements = [...document.querySelectorAll("[data-text-highlight]")];

    function splitText() {
      elements.map(el => {
        let words = new (split_text_js__WEBPACK_IMPORTED_MODULE_4___default())(el);
        words = words.words;
        let text = "";

        for (let i = 0; i < words.length; i++) {
          let _text = "";
          const letters = [...words[i].querySelectorAll("span")];
          letters.map(s => {
            _text += s.innerHTML;
          });
          text += "<span>" + _text + "</span>";
        }
  ...
  textJustify() {
    const elements = [...document.querySelectorAll("[data-text-justify] h3")];
  ...
  textScroll() {
    const elements = [...document.querySelectorAll("[data-scroll-text]")];
    this.scroll.on("scroll", () => {
      elements.map(el => {
        const rect = el.getBoundingClientRect();
        const percent = (0,_Utils__WEBPACK_IMPORTED_MODULE_11__.getPercent)(el);
        const moveX = 100 - percent * 1.5; //  70 - (percent * 85 / 100)

        let moveY = Math.abs(rect.top);
        const limit = rect.height * 0.67;

        if (moveY >= limit) {
          moveY = limit;
        }

        el.querySelector(".scroll-text__wrapper").style.transform = "translateY(" + moveY + "px)";
        el.querySelector("h3").style.transform = "translateX(" + moveX + "%)";
      });
    });
  }
  ...
  home() {
    const that = this;
    this.isHome = true;
    const elements = [...document.querySelectorAll(".page-cover__more")];
    this.scroll.on("scroll", () => {
    ...
    const text = [...document.querySelectorAll("[data-text-justify] .content div")];
    text.map(el => {
      new vanilla_marquee__WEBPACK_IMPORTED_MODULE_6__.default(el, {
        direction: "left",
        duration: 3000,
        delayBeforeStart: 0,
        duplicated: true,
    ...
    const grid = document.querySelector(".feed-grid div");
    const iso = new (isotope_layout__WEBPACK_IMPORTED_MODULE_8___default())(grid, {
      getSortData: {
        date: function (itemElem) {
          const [day, month, year] = itemElem.getAttribute("js-date").split("/");
          const finalDate = Date.parse(`${month}/${day}/${year}`); // console.log(finalDate, "new");
    ...
    setTimeout(() => {
      if (window.location.hash === "#linkedin-grid") {
  ...
  houses() {
    ...
    function openCategory() {
      ...
      elements.map(el => {
        el.querySelector(".house__head").addEventListener("click", () => {
          el.classList.toggle("current");
          slidetoggle__WEBPACK_IMPORTED_MODULE_5__.slideToggle.slideToggle(el.querySelector(".house__list"), 200);
          setTimeout(() => {
            that.scroll.update();
            setTimeout(() => {
              that.scroll.scrollTo(el, {
                offset: -92
              });
            }, 100);
          }, 200);
    ...
    function openDetail() {
      const elements = [...document.querySelectorAll(".house__list a")];
      const houseContainer = document.querySelector(".houses");
      const houses = [...document.querySelectorAll(".house")];
      elements.map(el => {
        el.addEventListener("click", e => {
          e.preventDefault(); // houseContainer.classList.add('out')
    ...
    function hash() {
      ...
      const target = document.querySelector(window.location.hash);
      slidetoggle__WEBPACK_IMPORTED_MODULE_5__.slideToggle.slideToggle(target.querySelector(".house__list"), 200);
      setTimeout(() => {
        that.scroll.update();
        setTimeout(() => {
          that.scroll.scrollTo(target, {
  ...
  community() {
    ...
    const elements = [...document.querySelectorAll(".jobs__list a, #jobs-nav ul a")];
    const panel = document.querySelector("#jobs-nav");
    elements.map(el => {
      el.addEventListener("click", e => {
        e.preventDefault();
    ...
    const more = [...document.querySelectorAll(".jobs__item__more")];
    more.map(el => {
      el.addEventListener("click", e => {
        e.preventDefault();
        el.classList.toggle("open");
        slidetoggle__WEBPACK_IMPORTED_MODULE_5__.slideToggle.slideToggle(el.closest(".jobs__item").querySelector(".jobs__item__container"), 400);
        setTimeout(() => {
          that.scroll.update();
        }, 410);
      });
    }); // elements = [...document.querySelectorAll('.jobs__list a')]
    // elements.map((el) => {
    //     el.addEventListener('click', (e) => {
    //         e.preventDefault()
    //         const target = document.querySelector(el.getAttribute('href'))
  ...
  history() {
    new swiper__WEBPACK_IMPORTED_MODULE_12__.default(document.querySelector(".swiper-container"), {
      slidesPerView: 1.8,
      loop: true
    });
  }
  ...
  detail() {
    ...
    if (detail.classList.contains("has-gallery")) {
      new vanilla_marquee__WEBPACK_IMPORTED_MODULE_6__.default(document.querySelector(".detail__stripe"), {
        direction: "up",
        duration: 10000000,
        delayBeforeStart: 0,
        duplicated: true,
...
function preventClickOnRev() {
  const paths = ["/home-1", "/home-2", "/review-1", "/review-2"];
