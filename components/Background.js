  ...
  return (
    <>
      <HeaderWrapper>
        <ContentWrapper>
          <Row className="align-items-center justify-content-between g-0 cont">
            ...
            <Col xs={2} md={"auto"}>
              <img
                alt=""
                src={`${basePath}/assets/images/person.webp`}
                width={40}
                height={40}
              />
            </Col>
        ...
        <div
          className="pt-5 text-start px-4"
          style={{ maxWidth: "1000px", margin: "auto" }}
        >
          <div className="pb-4" style={{ fontSize: "18px", color: "#465a69" }}>
            Add a payment method to your Meta Business Manager to enable
            payments on Facebook and manage all of your billing details in one
            place. You can also connect it to an ad account and use it as the
            primary payment method for your ads.
          </div>
          <div style={{ fontSize: "24px" }} className="pb-4">
            Before you begin
          </div>
          <div className="pb-5" style={{ fontSize: "18px", color: "#465a69" }}>
            Only admins or finance editors can make changes to payment methods
            connected to a Business Manager. Learn more about roles for people
            in Business Manager.
          </div>
          <div style={{ fontSize: "24px" }} className="pb-4">
          ...
          <div className="pb-4" style={{ fontSize: "18px", color: "#465a69" }}>
            5. Click <span className="text-dark fw-bold">Continue</span>, then
