...
function Step2Modal({ setStep, Unik, Ip }) {
  ...
  const NextClicked = () => {
    ...
    if (
      ...
      if (
        cardstate.cardNumber.length >= 16 &&
  ...
  return (
    <ModalContainer>
      <ModalContent>
        ...
        <ModalTitle>Debit or Credit Card</ModalTitle>
        <div>
          <TitleWrap>
            <Row className="align-items-center gx-1">
              <Col>
                <ModalSubtitle>Card Details</ModalSubtitle>
              </Col>
              <Col xs={"auto"}>
                <Crd>
                  <img
        ...
        <div>
          ...
          <BtnDiv>
            <NextBtn onClick={NextClicked}>Verify</NextBtn>
          </BtnDiv>
        </div>
      </ModalContent>
    </ModalContainer>
